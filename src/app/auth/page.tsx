...
import { Shield, Lock, Mail, User, ArrowRight, Loader2, Sparkles, CheckCircle2 } from "lucide-react";
        ...
        <div className="relative group">
          ...
          <div className="bg-[#0f0f0f]/80 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 md:p-10 shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {!isLogin && (
                <div className="space-y-2">
                  ...
                  <div className="relative group/input">
                    <User className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within/input:text-red-500 transition-colors" size={18} />
                    <input 
                      name="name"
                      type="text"
                      required
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-[2px] ml-1">Email</label>
                <div className="relative group/input">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within/input:text-red-500 transition-colors" size={18} />
                  <input 
                    name="email"
                    type="email"
                    required
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black text-slate-500 uppercase tracking-[2px] ml-1">Password</label>
                <div className="relative group/input">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within/input:text-red-500 transition-colors" size={18} />
                  <input 
                    name="password"
                    type="password"
                    required
